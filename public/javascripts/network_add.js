...
function loadMicrocontrollerLayout() {
  if (localStorage.getItem("network_microcontrollers")) {
    ...
    for (var i = 0; i < network_microcontrollers.length; i++) {
      ...
      edit_a.href = "/network/add/edit?mac_address=" + network_microcontrollers[i].microcontroller_mac_address;
      edit_a.textContent = "Edit";

      // view a
      var view_a = document.createElement("a");
      view_a.href = "/network/add/view?mac_address=" + network_microcontrollers[i].microcontroller_mac_address;
