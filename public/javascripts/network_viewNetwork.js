...
function loadMicrocontrollerLayout() {
  if (localStorage.getItem("network_microcontrollers")) {
    ...
    for (var i = 0; i < network_microcontrollers.length; i++) {
      ...
      edit_a.href = "/network/viewNetwork/edit?mac_address=" + network_microcontrollers[i].microcontroller_mac_address;
      edit_a.textContent = "Edit";

      // view a
      var view_a = document.createElement("a");
      view_a.href = "/network/viewNetwork/view?mac_address=" + network_microcontrollers[i].microcontroller_mac_address;
...
function addNewMicrocontroller () {
  $.getJSON("../api/microcontroller", function(data) {
    ...
    // edit a
    var edit_a = document.createElement("a");
    edit_a.href = "/network/viewNetwork/edit?mac_address=" + mac_address;
    edit_a.textContent = "Edit";

    // view a
    var view_a = document.createElement("a");
    view_a.href = "/network/viewNetwork/view?mac_address=" + mac_address;
    view_a.textContent = "View";
